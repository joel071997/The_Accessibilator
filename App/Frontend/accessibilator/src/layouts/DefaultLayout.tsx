          ...
          >
            ...
            <Dialog.Panel className='fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10'>
              <div className='flex items-center justify-between'>
                <Link
                  className='-m-1.5 p-1.5 text-2xl font-extrabold uppercase'
                  href='/'
                >
                  <span className='sr-only'>Accessibilator</span>
                  Accessibilator
                </Link>
                <button
                  type='button'
                ...
                <div className='-my-6 divide-y divide-gray-500/10'>
                  <div className='space-y-4 py-6'>
                    ...
                    <Button
                      role='navigation'
                      variant='link'
                      className='px-0 py-2 text-lg font-semibold text-stone-900 '
                      text={'Send Feedback'}
                      onClick={() => {
                        setIsShowingFeedback(true);
                      }}
                  ...
                  <Disclosure as='div' className='-mx-3'>
                    {({ open }) => (
                      <>
                        <Disclosure.Button className='mt-2 flex w-full items-center justify-between rounded-lg py-4 pl-3 pr-3.5 text-lg font-semibold leading-7 text-stone-900 hover:bg-gray-50'>
                          Login
                          <ChevronDownIcon
